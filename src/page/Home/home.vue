<template>
  ...
  <div v-loading="loading" element-loading-text="加载中..." style="min-height: 35vw;" v-if="!error">
      ...
      <section class="w mt30 clearfix">
        ...
        <y-shelf title="热门保险推荐！">
          <div slot="content" class="floors" >
            ...
            <mall-goods :msg="iitem" v-for="(iitem,j) in RandomGoods" :key="j+'key'"></mall-goods>
          </div>
    ...
    <el-dialog
      ...
      <span>欢迎来到CTGU保险推荐系统！</span>
      <span slot="footer" class="dialog-footer">
        <el-button type="primary" @click="dialogVisible = false">了解！</el-button>
      </span>
    </el-dialog>
  </div>
