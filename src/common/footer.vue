<template>
  <div class="footer">
    <div class="container">
      <div class="siteinfo">
        <ul class="c0">
          ...
          <ul>
            ...
            <li class="c2"><a class="c3" @click="open3">购买指南</a></li>
        ...
        <ul class="c0">
          <h3 class="c1">服务支持</h3>
          <ul>
            <li class="c2"><a class="c3" target="_blank" href="https://www.ctgu.edu.cn/">学校官网</a></li>
            <!-- <li class="c2"><a class="c3" target="_blank" href="https://github.com/Exrick/xmall-front">项目前端</a></li> -->
            <li class="c2"><router-link to="/home"><a class="c3" target="_blank">项目前端</a></router-link></li>
            <!-- <li class="c2"><a class="c3" target="_blank" href="https://github.com/Exrick/xmall">项目后端</a></li> -->
            <li class="c2"><router-link to="/home"><a class="c3" target="_blank">项目后端</a></router-link></li>
          </ul>
        </ul>
        <ul class="c0">
          <h3 class="c1">自助服务</h3>
          <ul>
            <li class="c2"><router-link to="/home"><a class="c3" target="_blank">保险常识</a></router-link></li>
            <li class="c2"><router-link to="/home"><a class="c3" target="_blank">商品简介</a></router-link></li>
            <li class="c2"><router-link to="/home"><a class="c3" target="_blank">宣传视频</a></router-link></li>
          </ul>
        </ul>
        <!-- <ul class="c0">
          <h3 class="c1">其他项目</h3>
        ...
        <ul class="c0">
          <h3 class="c1">关注我们</h3>
          <ul>
            <li class="c2"><router-link to="/home"><a class="c3" target="_blank">腾讯 QQ</a></router-link></li>
            <li class="c2"><router-link to="/home"><a class="c3" target="_blank">新浪微博</a></router-link></li>
            <li class="c2"><router-link to="/home"><a class="c3" target="_blank">官方邮箱</a></router-link></li>
          </ul>
        </ul>

        <!-- <ul class="c4">
          <li class="tel"><a class="c5" href="http://wpa.qq.com/msgrd?v=3&uin=1012139570&site=qq&menu=yes" target="_blank">123456789</a></li>
      ...
      <div class="copyright">
        <h4 class="content-c2">Copyright ©2022</h4>
        <ul class="privacy">
  ...
  export default {
    ...
    methods: {
      open1 () {
        this.$notify.info({
          title: '法律声明',
          message: '此项目仅做算法推荐逻辑需要，仅供学习参考，不承担任何法律问题'
        })
      },
      open2 () {
        this.$notify.info({
      ...
      open5 () {
        this.$notify({
          title: '送货政策',
          message: '本网站所有保险购买后不会发货，请联系管理人员',
          type: 'warning'
        })
      }
    },
