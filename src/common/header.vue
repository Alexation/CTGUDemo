    ...
    <div class="header-wrapper">
      ...
      <header class="w">
        <div class="w-box">
            ...
            <div class="fontSet">
              <a href="/" style="color: inherit;">CTGU保险推荐系统</a>
              <!-- <router-link to="/" title="CTGU保险推荐系统">CTGU保险推荐系统</router-link> -->
            </div>
                    ...
                    <div class="nav-user-list">
                      <ul>
                        ...
                        <li class="nav-user-avatar">
                          <div>
                            <span class="avatar" :style="{backgroundImage:'url('+userInfo.info.faceIcon+')'}">
                            </span>
                          </div>
...
<script>
  ...
  export default{
    ...
    methods: {
      ...
      //     st === 0 ? this.st = true : this.st = false
    ...
    //     if(t>0){
    //         $('.header-box').addClass('header-active')
    //     }else{
    //         $('.header-box').removeClass('header-box')
    //     }
    //  },
